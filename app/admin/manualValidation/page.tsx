    ...
    try {
      ...
      const uploadData = csvData.map((row) => {
        return {
          ...
          code: row.code || code,
          valid: row.valid,
          email: row.email || "user@email.com",
          selected: false,
        };
      });
      ...
      const response = await action(uploadData, "chuo-university", 1);
      ...
      const csv = Papa.unparse(response.result);
      await downloadCSV(csv, "upload_result.csv");
  ...
  return (
    <>
      <div>
        <div className="mb-4">
          <label
            className="block mb-2 text-normal font-medium text-gray-900"
            htmlFor="file_input"
          >
          ...
          <div className="z-50 px-15 py-auto">
            ...
            >
              <div className="relative p-4 w-full max-w-2xl h-full">
                <div className="relative bg-white rounded-lg shadow max-h-full overflow-hidden flex flex-col">
        ...
        <>
          ...
          <div>
            ...
            {isUploading ? (
              <button
                type="button"
                className="flex items-center justify-center py-2.5 px-5 me-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100"
              >
                <div role="status">
                  <svg
                    aria-hidden="true"
          ...
          >
            <form className="relative p-4 w-full max-w-2xl h-full">
              <div className="relative bg-white rounded-lg shadow max-h-full overflow-hidden flex flex-col">
                  ...
                  <div className="grid gap-6 md:grid-cols-2">
                    ...
                    <div className="col-span-2">
                      ...
                      <input
                        type="text"
                        id="email"
                        value={(selectedData.email as string) || ""}
                        onChange={handleValueChange}
                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                ...
                <div className="flex items-center justify-between p-4 md:p-5 border-t border-gray-200 rounded-bd">
                  <button
                    type="button"
                    className="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100"
                    onClick={() => {
